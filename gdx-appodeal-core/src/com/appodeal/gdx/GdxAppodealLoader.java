...
public class GdxAppodealLoader {
    ...
    public static GdxAppodeal buildAPI() {
        loadGdxReflections();
    ...
    private static GdxAppodeal getIOSAppodealAPI() {
        try {
    ...
    private static GdxAppodeal getAndroidAppodealAPI() {
        try {
