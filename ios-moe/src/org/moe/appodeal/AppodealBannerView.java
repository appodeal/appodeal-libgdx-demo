...
@ObjCClassBinding
public class AppodealBannerView extends APDBannerView {
	static {
		NatJ.register();
	}

	@Generated
	protected AppodealBannerView(Pointer peer) {
		super(peer);
	}
	...
	@Owned
	@Selector("alloc")
	public static native AppodealBannerView alloc();
	...
	@Generated
	@Selector("init")
	public native AppodealBannerView init();

	@Generated
	@Selector("initWithCoder:")
	public native AppodealBannerView initWithCoder(NSCoder aDecoder);

	@Generated
	@Selector("initWithFrame:")
	public native AppodealBannerView initWithFrame(@ByValue CGRect frame);

	@Generated
	@Selector("initWithSize:")
	public native AppodealBannerView initWithSize(@ByValue CGSize adSize);

	@Generated
	@Selector("initWithSize:rootViewController:")
	public native AppodealBannerView initWithSizeRootViewController(
			@ByValue CGSize size, UIViewController rootViewController);
